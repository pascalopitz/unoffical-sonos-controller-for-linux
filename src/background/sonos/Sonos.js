 ...
 */
Sonos.prototype.goto = function(trackNumber, callback) {
 ...
 * @return {[type]}
 */
Sonos.prototype.setGroupVolume = function(muted, callback) {
  /*
  var actions = [];
  var count = 0;
 ...
 * @return {[type]}
 */
Sonos.prototype.setGroupMuted = function(muted, callback) {
