...
```bash
chmod +x sonos-controller-unofficial-amd64-0.2.9.AppImage
```
...
Exec="/home/username/Downloads/sonos-controller-unofficial-0.2.9.AppImage" %U
```
...
```bash
sudo dpkg -i sonos-controller-unofficial_0.2.9_amd64.deb
```
