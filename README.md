...
```bash
chmod +x sonos-controller-unofficial-amd64-0.3.0-alpha4.AppImage
```
...
Exec="/home/username/Downloads/sonos-controller-unofficial-0.3.0-alpha4.AppImage" %U
```
...
```bash
sudo dpkg -i sonos-controller-unofficial_0.3.0-alpha4_amd64.deb
```
