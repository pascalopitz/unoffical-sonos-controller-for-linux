...
```bash
chmod +x sonos-controller-unofficial-amd64-0.2.1-alpha4.AppImage
```
...
Exec="/home/username/Downloads/sonos-controller-unofficial-0.2.1-alpha4.AppImage" %U
```
...
```bash
sudo dpkg -i sonos-controller-unofficial-amd64-0.2.1-alpha4.AppImage
```
